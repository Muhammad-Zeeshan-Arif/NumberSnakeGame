	...
	static public InputRig activeRig
		...
		set 
			...
			if (mRig != null)
				...
				mMultiTouchEnabled			= UnityEngine.Input.multiTouchEnabled;
				}
			...
			if (mRig != null)	
				...
				UnityEngine.Input.multiTouchEnabled				= true;	// Enable multi touch...
				}
			else 
				{
				...
				UnityEngine.Input.multiTouchEnabled				= mMultiTouchEnabled;		
